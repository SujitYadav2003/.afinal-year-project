...
#         # =============== checkbutton ==============
#         self.var_check=IntVar()      #  check value variable
#         checkbtn=Checkbutton(frame,variable=self.var_check, text = "I Agree The Term & comdition",font=("times new roman",12,"bold"),onvalue=1,offvalue=0 )
#         checkbtn.place(x=50 , y = 380)
...
#     #     img=img.resize((200,55),Image.ANTIALIAS)
#     #     self.photoimage=ImageTk.PhotoImage(img)
#     #     b1=Button(frame,image=self.photoimage,command=self.register_data,borderwidth=0,cursor="hand2",font=("tims new roman",15,"bold"))
#     #     b1.place(x=10,y=420,width=200)
#     #     # b1.place(x=10, y=10, width=200)

#     #     # img1=Image.open(r"D:\z\trial3\image\login.jpg")
#     #     img1=Image.open(r"D:\z\trial3\image\lgin2.jpg")
#     #     img1=img1.resize((200,55),Image.ANTIALIAS)
#     #     self.photoimage1=ImageTk.PhotoImage(img1)
...
#     #     elif self.var_check.get()==0:
#     #         messagebox.showerror("Error","Please agree with the terms & conditions.",parent=self.root)
#     #     else:
#     #         # messagebox.showinfo("Success","Welcome Client")
#     #         conn=mysql.connector.connect(host="localhost",user="root",password="4381",database="today")
#     #         my_cursor=conn.cursor()
#     #         query=("select * from register where email=%s")
#     #         value=(self.var_email.get(),)
...
#     #         row=my_cursor.fetchone()
#     #         if row!=None:
#     #             messagebox.showerror("Error","User already exist","please from another Email",parent=self.root)
#     #         else:
